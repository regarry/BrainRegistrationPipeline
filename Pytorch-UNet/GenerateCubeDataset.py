...
volume_size = 512
cube_sizes = list(range(volume_size//2, volume_size, (volume_size-volume_size//2)//5))
image_format = '.png'
input_path = './brain_1/masks/'
output_dir =  './cube/'
angles = list(range(10, 360, 90))
...
for cube_size in tqdm(cube_sizes):
    for angle in angles:
        for dimension in dimensions:
            output_path = output_dir + f'masks_{cube_size}_{angle}_{dimension[0]}{dimension[1]}/'
